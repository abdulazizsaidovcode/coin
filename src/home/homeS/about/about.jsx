...
const About = () => {
    return (
        <>
            <div className="max-w-screen-xl mx-auto md:flex block flex-wrap aboutMain  items-center justify-between h-60 mt-20 md:mb-[30rem] mb-[40rem] " id="3">
                ...
                <div className='content-section md:w-[50%] w-full '>
                    <div className='aboutP mb-5 '>
                        <h1 className='text-5xl  md:text-start text-center font-extrabold '>About <br />  Company</h1>
                    </div>
