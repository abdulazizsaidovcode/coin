            ...
            <div className="flex items-center justify-center h-screen signin w-full z-10">
                <div className="bg-white p-8 rounded-lg shadow-lg w-96 font-inika">
                    ...
                    <div className={`mt-5`}>
                        <label
                            for="phoneNumber"
                            className="block mb-1 font-bold text-gray-500 hover:text-gray-600 duration-500">Phone Number</label>
                        <input
                            id="phoneNumber"
                            type="number"
                    ...
                    <div className="mt-5">
                        <label
                            for="password"
                            className="block mb-1 font-bold text-gray-500 hover:text-gray-600 duration-500">Password</label>
