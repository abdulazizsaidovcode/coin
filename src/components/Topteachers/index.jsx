...
const TopTeachers = () => {
  ...
  const teachers = new Array(20).fill(null).map((_, i) => ({
    number: i + 1,
    name: `Teacher ${i + 1}`,
    group: 'Java',
    exchange: '154',
  ...
  return (
    <div className="bg-white rounded-lg shadow-md px-5 py-5">
              ...
              <tr key={index} className="border-t border-gray-200">
                <td className="px-5 py-3 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="text-gray-900">{teacher.number}</div>
                    <img
                ...
                <td className="px-5 py-3 whitespace-nowrap text-gray-500">{teacher.group}</td>
                <td className="px-5 py-3 whitespace-nowrap text-gray-500">{teacher.exchange}</td>
                <td className="px-5 py-3 whitespace-nowrap text-gray-500">{teacher.tasks}</td>
      ...
      <Pagination itemsPerPage={teachersPerPage} totalItems={teachers.length} paginate={paginate} />
    </div>
  );
};
