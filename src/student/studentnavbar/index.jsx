...
const StudentNavbar = () => {
  ...
  const editMe = () => {
    ...
    axios
      .put(url + "user/editStudentProfile", addData, config)
      .then(() => {
        ...
        <div className="w-full flex justify-between bg-white p-2">
          ...
          >
            ...
            <div className="h-40 bg-profileColor rounded-t-xl flex justify-center items-center">
              <img className="w-20 h-20 rounded-full" src="" alt="Gift" />
              <span
                ...
                <div className="modal-overlay" onClick={closeModal}>
                  ...
                  >
                    ...
                    <div className="modal-footer">
                      ...
                      <button onClick={editMe} className="save-button">
                        Save
                      </button>
                    </div>
                  </div>
