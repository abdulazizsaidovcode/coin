...
function SidebarTemplateStudent() {
    return (
        <>
                    ...
                    <ul className="flex flex-col py-4 space-y-1">
                        ...
                        <li>
                            <Link to="/student/gift"
                                ...
                                <span className="ml-2 text-sm tracking-wide truncate">Gift</span>
                            </Link>
                        </li>
                        <li>
...
export default SidebarTemplateStudent;